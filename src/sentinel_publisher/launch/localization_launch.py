...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('sentinel_publisher')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map', default_value='/home/sentinel/sentinel_ws/src/sentinel_publisher/maps/teras_lab.yaml', description='Full path to map yaml file to load'
    )
