...
- [SENTINEL: Adaptive Traction Control for Differential AMR using TinyML Surface Classification on μT-Kernel 3.0](#sentinel-adaptive-traction-control-for-differential-amr-using-tinyml-surface-classification-on-μt-kernel-30)
  ...
  - [TinyML Pipeline](#tinyml-pipeline)
    ...
    - [Dataset Collection](#dataset-collection)
      - [Setup](#setup)
      - [Protocol](#protocol)
      - [Maneuver patterns](#maneuver-patterns)
      - [Data validation](#data-validation)
    - [Feature Engineering](#feature-engineering)
      - [The problem](#the-problem)
      - [84 features across three tiers](#84-features-across-three-tiers)
      - [Aggregation](#aggregation)
      - [Session leakage: the voltage feature](#session-leakage-the-voltage-feature)
    - [Model Selection & Validation](#model-selection--validation)
      ...
      - [Temporal voting](#temporal-voting)
    - [Export to C — m2cgen](#export-to-c--m2cgen)
      - [What the generated code looks like](#what-the-generated-code-looks-like)
      - [Why this suits an MCU](#why-this-suits-an-mcu)
      - [Compilation: `-Os` is mandatory](#compilation--os-is-mandatory)
      - [`double` vs `float`](#double-vs-float)
      - [Golden test vectors](#golden-test-vectors)
  - [ROS2 Integration](#ros2-integration)
    - [Architecture](#architecture)
    - [Hardware Interface — `diffdrive_arduino`](#hardware-interface--diffdrive_arduino)
      - [Protocol](#protocol-1)
      - [Configuration](#configuration)
    - [Classifier Node — `sentinel_classifier_node`](#classifier-node--sentinel_classifier_node)
      - [Why a separate link](#why-a-separate-link)
      - [Input format](#input-format)
      - [Published topics](#published-topics)
    - [Serial Port Setup](#serial-port-setup)
    - [Running](#running)
    - [Debugging Notes](#debugging-notes)
      - [`ReadByte() call has timed out`](#readbyte-call-has-timed-out)
      - [Two processes on one port](#two-processes-on-one-port)
      - [`XMLPARSER Error: realpath failed`](#xmlparser-error-realpath-failed)
  ...
  - [Results](#results)
    ...
    - [Classification Performance](#classification-performance)
      - [Overall](#overall)
      - [Per class](#per-class)
    - [Gain Scheduling Verification](#gain-scheduling-verification)
      - [Tuning results](#tuning-results)
      - [Proving the gains actually change](#proving-the-gains-actually-change)
...
#### How to Login Raspi
[How to Login Raspi , come and see this guide](https://github.com/kikifachrizi/Sentinel_Project/blob/main/docs/raspi_setup.md)
...
PID parameters are intentionally **not** passed from the xacro. Gains live in the firmware, where gain scheduling modifies them at runtime. If `pid_p` were set here, the plugin would overwrite the scheduled gains on every activation.
